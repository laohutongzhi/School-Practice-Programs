...
while running:
    ...
    if running==True:
        if monsterblood>0:  #检查怪兽是否被击败
            if monsterblood==1000:
                monster_skill=randint(1,2)
            else:
